#!/usr/bin/env python3
"""
A3: DTW + Beat Weighting Experiment
Evaluates alignment metrics for all 10 Bach chorales and 4 instruments using beat weighting.
...
# DTW alignment with beat weighting
...
with open('dtw_beatweight_results.txt', 'w') as txtf:
...
with open('dtw_beatweight_results.json', 'w') as f:
