#!/usr/bin/env python3
"""
A2: DTW + ScoreGraph Context Experiment
Evaluates alignment metrics for all 10 Bach chorales and 4 instruments using ScoreGraph context constraints.
...
with open('dtw_scoregraph_results.txt', 'w') as txtf:
...
with open('dtw_scoregraph_results.json', 'w') as f:
