#!/usr/bin/env python3
"""
A1: Baseline DTW Experiment (Chroma-based)
Evaluates alignment metrics (MAE, RMSE, note-matching accuracy) for all 10 Bach chorales and 4 instruments.
...
with open('baseline_dtw_results.txt', 'w') as txtf:
...
with open('baseline_dtw_results.json', 'w') as f:
