...
class GradingLayer:
    ...
    def compute_final_grade(self, grading_package: Optional[Dict] = None) -> Dict[str, Any]:
        ...
        self.logger.info(f"  {'LETTER GRADE':.<30} {letter_grade:>10}")
        ...
        # 4. Create final grade object
        self.final_grade = {
            'overall_score': round(weighted_score, 2),
            'letter_grade': letter_grade,
            'grade_interpretation': self._interpret_letter_grade(letter_grade),
    ...
    def _print_grade_summary(self):
        ...
        self.logger.info(f"Letter Grade: {self.final_grade['letter_grade']}")
        self.logger.info(f"\n{self.final_grade['grade_interpretation']}")
        self.logger.info("\n" + "-" * 80)
    ...
    def _save_text_report(self, filepath: Path):
        ...
        with open(filepath, 'w') as f:
            ...
            f.write(f"Letter Grade: {self.final_grade['letter_grade']}\n\n")
            f.write(f"{self.final_grade['grade_interpretation']}\n\n")
