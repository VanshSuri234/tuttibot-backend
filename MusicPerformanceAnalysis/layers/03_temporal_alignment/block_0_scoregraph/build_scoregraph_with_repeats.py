...
def build_scoregraph(score_path, meta_path, seg_path=None):
    ...
    try:
        ...
        print("Info: No repeats to expand or expansion failed, using original score")
    ...
    for measure in measures:
        ...
        for beat in range(1, numerator + 1):
            ...
            node = {
                ...
                'D_beats': D_beats,
                'flags': flags,
                'edges': []  # Will be populated after all nodes are created
            }
            nodes.append(node)
            abs_beat += D_beats
    
    # Add edges: each node points to the next beat in sequence
...
def main():
    ...
    with open('scoregraph.json', 'w') as f:
        ...
        # Return the complete scoregraph
